...
# Параметры
BUNDLE_ID="com.monarchog.mold"
APPLE_ID="6749773484"
REMOTE_URL="git@github.com:sdeslvm/Monarch-Online-Gaming.git"
PROJECT_NAME="Monarch Online Gaming"
SCHEME_NAME="Monarch Online Gaming"
