...
protocol WebLoadable: AnyObject {
    var state: MonarchWebStatus { get set }
...
final class MonarchWebLoader: NSObject, ObservableObject, WebLoadable, ProgressMonitoring {
    // MARK: - Свойства

    @Published var state: MonarchWebStatus = .standby
...
extension MonarchWebLoader: WKNavigationDelegate {
