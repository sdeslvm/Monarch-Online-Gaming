...
enum MonarchWebStatus: Equatable, WebStatusComparable {
    case standby
    ...
    func isEquivalent(to other: MonarchWebStatus) -> Bool {
        switch (self, other) {
...
extension MonarchWebStatus {
    static func == (lhs: MonarchWebStatus, rhs: MonarchWebStatus) -> Bool {
