...
struct MonarchWebViewBox: UIViewRepresentable {
    // MARK: - Свойства

    @ObservedObject var loader: MonarchWebLoader

    // MARK: - Координатор

    func makeCoordinator() -> MonarchWebCoordinator {
        MonarchWebCoordinator { [weak loader] status in
